...
class _MyAppState extends State<MyApp> {
  ...
  void listenDynamicLinks() async {
    streamSubscription = FlutterBranchSdk.initSession().listen((data) {
      print('[ WowNovel ]listenDynamicLinks - DeepLink Data: $data');
      controllerData.sink.add((data.toString()));
      if (data.containsKey('+clicked_branch_link') &&
          data['+clicked_branch_link'] == true) {
        print(
            '------------------------------------Link clicked----------------------------------------------');
        print('[ WowNovel ]Custom string: ${data['custom_string']}');
        print('[ WowNovel ]Custom number: ${data['custom_number']}');
        print('[ WowNovel ]Custom bool: ${data['custom_bool']}');
        print('[ WowNovel ]Custom list number: ${data['custom_list_number']}');
        print(
            '------------------------------------------------------------------------------------------------');
        showSnackBar(
          ...
          children: <Widget>[
                ...
                Expanded(
                  child: RaisedButton(
                    ...
                    onPressed: () async {
                      ...
                      print('[ WowNovel ]Remove sucess: $success');
                ...
                Expanded(
                  child: RaisedButton(
                    ...
                    onPressed: () async {
                      ...
                      print('[ WowNovel ]isUserIdentified: $isUserIdentified');
                      ...
                      if (response.success) {
                        ...
                        print('[ WowNovel ]Redeeming Credits: $success');
            ...
            RaisedButton(
                ...
                onPressed: () async {
                  ...
                  if (response.success) {
                    print('[ WowNovel ]Credits Hystory: ${response.result}');
                    showSnackBar(
                        message:
